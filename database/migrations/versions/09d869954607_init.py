...
Revision ID: 09d869954607
Revises: 
Create Date: 2023-08-03 21:54:20.350112
...
def upgrade() -> None:
    ...
    sa.Column('classid', sa.String(length=64), nullable=True),
    sa.Column('stackid', sa.Integer(), nullable=True),
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=True),
    sa.ForeignKeyConstraint(['classid'], ['items.classid'], ),
    sa.ForeignKeyConstraint(['stackid'], ['assetstacks.id'], ),
